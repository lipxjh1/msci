        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          ...
          >
            ...
            <motion.p 
              ...
              variants={itemVariants}
            >
              Stake your $MSCI tokens to earn passive rewards, unlock exclusive benefits, and gain governance rights. Multiple staking pools with different reward structures will be available.
            </motion.p>
            ...
            >
              ...
              >
                <div className="relative h-[500px] w-[350px]">
                  <Image
                    src="/images/heronoew/player_14_henry.png"
                    alt="Staking & Rewards Character"
                    fill
