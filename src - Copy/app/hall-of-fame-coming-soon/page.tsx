...
export default function HallOfFameComingSoonPage() {
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          ...
          >
            ...
            <motion.p 
              ...
              variants={itemVariants}
            >
              A space dedicated to honoring our most exceptional players. Follow and participate for a chance to make your mark in gaming history.
            </motion.p>
