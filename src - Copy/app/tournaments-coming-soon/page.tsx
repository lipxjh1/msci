...
export default function TournamentsComingSoonPage() {
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          ...
          >
            ...
            <motion.p 
              ...
              variants={itemVariants}
            >
              Get ready for exciting and intense tournaments. A place where you can compete, showcase your skills, and win valuable prizes.
            </motion.p>
