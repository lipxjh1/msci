...
export default function TokenomicsComingSoonPage() {
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          ...
          >
            ...
            <motion.p 
              ...
              variants={itemVariants}
            >
              Our comprehensive tokenomics plan will detail token allocation, vesting schedules, utility, and economic model. Designed for long-term stability and community rewards.
            </motion.p>
            ...
            >
              ...
              >
                <div className="relative h-[500px] w-[350px]">
                  <Image
                    src="/images/heronoew/player_18_victorya.png"
                    alt="Tokenomics Character"
                    fill
