...
export default function GachaPage() {
  ...
  return (
    <main className="min-h-screen bg-[#041019] text-white overflow-hidden">
      ...
      <div id="gacha-content" className="max-w-7xl mx-auto px-4 py-12 relative z-10 -mt-10">
        {/* Curved section top */}
        ...
        <div className="bg-[#05121d]/80 backdrop-blur-sm p-8 rounded-2xl border border-[var(--accent-blue-bright)]/30 my-10 shadow-lg shadow-[var(--accent-blue-bright)]/5">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-300 max-w-2xl mx-auto">Thử vận may của bạn với hệ thống Gacha độc đáo. Quay để có cơ hội nhận được các nhân vật hiếm với tỷ lệ rơi khác nhau.</p>
          </div>
          ...
          <div className={`transition-opacity duration-500 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
            ...
            <div className="flex justify-center mt-8">
              <button
                onClick={handleSpin}
                disabled={isSpinning}
                className={`font-rajdhani text-xl font-bold tracking-wider px-12 py-4 button-cyber clip-hexagon hexagon-border text-white transition-all duration-300 ${
      ...
      {/* Decorative elements */}
      <div className="absolute top-1/4 left-8 w-20 h-20 rotate-45 border border-[var(--accent-blue-bright)]/30 rounded-lg opacity-50 animate-pulse-slow hidden md:block"></div>
      <div className="absolute bottom-1/4 right-8 w-16 h-16 rotate-12 border border-[var(--accent-blue-bright)]/30 rounded-lg opacity-50 animate-pulse-slow delay-300 hidden md:block"></div>
