        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          ...
          >
            ...
            <motion.p 
              ...
              variants={itemVariants}
            >
              We're building an extraordinary marketplace for exclusive items, heroes, and more. Stay tuned for an immersive trading experience.
            </motion.p>
            ...
            >
              ...
              <div className="text-left">
                <p className="text-sm text-purple-300">Launch Estimated</p>
