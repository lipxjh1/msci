...
export default function DonateComingSoonPage() {
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          ...
          >
            ...
            <motion.p 
              ...
              variants={itemVariants}
            >
              Support our game development with exclusive donation packages. Receive unique in-game items, special recognition, early access, and VIP perks based on your contribution level.
            </motion.p>
              ...
              >
                <div className="relative h-[500px] w-[350px]">
                  <Image
                    ...
                    alt="Donation Packages Character"
                    fill
