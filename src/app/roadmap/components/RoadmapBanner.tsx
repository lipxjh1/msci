  ...
  return (
    <div className="relative h-[100vh] overflow-hidden">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center px-4 z-20">
        ...
        <p className="font-rajdhani text-xl md:text-2xl text-[var(--accent-blue-bright)] font-semibold mb-10 tracking-wide uppercase text-center animate-fade-in">
          TỪ GAME VIỆT ĐẾN HIỆN TƯỢNG TOÀN CẦU (2024-2030)
        </p>
