...
export default function SocialHubComingSoonPage() {
  ...
  useEffect(() => {
    ...
    // Tạo particles với giá trị ngẫu nhiên chỉ ở phía client
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          ...
          >
            ...
            <motion.p 
              ...
              variants={itemVariants}
            >
              We're developing a social connection space for the gaming community, where you can interact, share, and engage with other players from around the world.
            </motion.p>
            ...
            >
              ...
              >
                <div className="relative h-[500px] w-[350px]">
                  <Image
                    src="/images/heroin/ui 4.png"
                    alt="Social Hub Character"
                    fill
