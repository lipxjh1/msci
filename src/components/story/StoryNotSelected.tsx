...
const StoryNotSelected: React.FC<StoryNotSelectedProps> = ({ message }) => {
  return (
      ...
      {message ? (
        ...
        <>
          ...
          <p className="text-gray-600 dark:text-gray-400 max-w-md mx-auto">
            Khám phá thế giới MSCI thông qua những câu chuyện hấp dẫn và hành trình của các nhân vật
          </p>
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4 max-w-3xl mx-auto">
            <div className="p-4 bg-blue-100 dark:bg-blue-900 rounded-lg">
              ...
              <p className="text-sm text-gray-700 dark:text-gray-300">
                Tận hưởng những câu chuyện đầy cảm xúc trong thế giới MSCI
              </p>
            </div>
            ...
            <div className="p-4 bg-green-100 dark:bg-green-900 rounded-lg">
              ...
              <p className="text-sm text-gray-700 dark:text-gray-300">
                Chia sẻ trải nghiệm đọc truyện với cộng đồng fan MSCI
              </p>
            </div>
          </div>
        </>
